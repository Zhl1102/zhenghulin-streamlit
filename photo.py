...
def pp():
		...
		st.write("---------------------------------")
		st.subheader("个人简介")
		personal_info = pd.read_csv("/Users/watermelon/PycharmProjects/pythonStreamlit/个人信息.csv", index_col=0)
		st.dataframe(personal_info)

		st.subheader("专业技能")
		st.markdown("掌握Python编程语言，熟悉RabbitMQ、MySQL(PXC)数据库，Linux操作系统及命令行基本操作，"\
						"了解Docker和K8S知识和基本操作，有良好的代码设计编写和调试代码的能力。")

		st.subheader("实习经历")
		internship = '2021.11-至今|玛蒂尔德(北京)科技有限公司|测试开发''隶属中间件测试团队，\
